...
Route::prefix('/collaborators')->group(function () {
    ...
    Route::prefix('/foods')->group(function () {
        ...
        Route::get('/{food_id}', [CollaboratorController::class, 'getFood'])->name('collaborators.foods.get');
        Route::post('/update/{food_id}', [CollaboratorController::class, 'updateFood'])->name('collaborators.foods.update');
    });
    ...
    Route::prefix('/restaurants')->group(function () {
        ...
        // Tìm kiếm nhà hàng theo ID và các món ăn tương ứng. 5 món ăn 1 trang
